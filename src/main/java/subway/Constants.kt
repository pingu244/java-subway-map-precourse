...
const val MAIN_MENU = "메인 화면\n" +
        ...
        "4. 지하철 노선도 출력\n" +
        "Q. 종료\n"
const val CHOOSE_MENU = "원하는 기능을 선택하세요."
const val STATION_MENU = "역 관리 화면\n" +
        "1. 역 등록\n" +
        "2. 역 삭제\n" +
        "3. 역 조회\n" +
        "B. 돌아가기\n"
...
const val INSERT_STATION_NAME = "등록할 역 이름을 입력하세요."
const val INSERT_DELETE_STATION_NAME = "삭제할 역 이름을 입력하세요."
...
const val INSERT_LINE_NAME = "등록할 노선 이름을 입력하세요."
const val INSERT_START_LINE = "등록할 노선의 상행 종점역 이름을 입력하세요."
const val INSERT_END_LINE = "등록할 노선의 하행 종점역 이름을 입력하세요."
const val SUCCESS_REGISTER_LINE = "지하철 노선이 등록되었습니다."
